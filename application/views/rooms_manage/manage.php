...
<div id="title_bar">
    ...
    <div id="new_button">
        ...
        "<div class='big_button' style='float: left;'><span>".$this->lang->line($controller_name.'_add')."</span></div>",
        array('class'=>'thickbox none','title'=>$this->lang->line($controller_name.'_add')));
        ?>
    </div>
</div>
